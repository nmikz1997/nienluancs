	...
	<nav class="navbar navbar-default">
	  <div class="container-fluid">
	    ...
	    <ul class="nav navbar-nav">
	      ...
	      <li class="active"><a href="them_theloai.php">Thêm nhà xuất bản</a></li>
	    </ul>
	  </div>
	</nav>
...
<div>
	<form enctype ="multipart/form-data" action="" method ="POST">
		<div class="container">
		<caption><h3>Thêm nhà xuất bản</h3></caption>
			<div class="form-group">
				<label>Mã nhà xuất bản</label>
				<input type="text" class = "form-control" name="manxb" required>
			</div>
			<div class="form-group">
