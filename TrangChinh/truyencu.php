	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    <ul class="navbar-nav mr-auto">
	      	...
	      	<li class="nav-item active">
	       		<a class="nav-link" href="#">Truyện cũ<span class="sr-only">(current)</span></a>
	    	</li>
	      	<li class="nav-item active">
	    ...
	    <div>
		    <form class="form-inline my-2 my-lg-0" action="tim_truyen.php" method="GET">
		      ...
		      <input type="hidden" value="old" name="tinhtrang">
		      <button class="btn btn-outline-success my-2 my-sm-0" type="submit" value="timtruyen">Tìm truyện cũ</button>
		    </form>
	    </div>
...
<?php
	...
	$select="SELECT truyen.matruyen,tentruyen,bia,gia,soluong 
				...
				where soluong > 0 and tinhtrang='old'
				limit 8";
...
<div class="container">
	<div class="row mt-5">
		<h3 class="list-product-title">Truyện cũ</h3>
					...
					while ($row = mysqli_fetch_assoc($hienthi)) {
						...
						<div class='col-md-3 col-sm-6 col-12'>
							...
							<div class='card-header border-0'>
							  <img class='card-img-top' src=../Database/Old/".$row["bia"]." height=240px width=200px alt='Card image cap'>
							</div>
							  <div class='card-body'>
							    <h6 class='card-title'>".$row["tentruyen"]."</h6>
							    <h6 class='card-text'>".number_format($row["gia"],0,',','.')." VNĐ</h6>
							    <a href='chitietTruyen.php?matruyen=".$row['matruyen']."&tinhtrang=old' class='btn btn-primary'>Xem chi tiết</a>
							    <a href='addtocart.php?matruyen=".$row['matruyen']."&tinhtrang=old' class='btn btn-success'>Chọn mua</a>
							  </div>
							</div>
						</div>
						";
