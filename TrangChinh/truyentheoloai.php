<?php
	session_start();
	if(empty($_GET['maloai']) ){header("location:trangchu.php");};
?>
...
<?php
	...
	$select="SELECT truyen.matruyen,tentruyen,gia,bia,theloai.maloai,tenloai
				from loai_truyen
					join truyen on truyen.matruyen=loai_truyen.matruyen
					join chitiettruyen on truyen.matruyen=chitiettruyen.matruyen
					join theloai on theloai.maloai=loai_truyen.maloai
				where theloai.maloai='$maloai' and tinhtrang='new'
				group by matruyen";
						...
						if ($num_rows == 0) {
							...
							<div class='card-header border-0'>
							  ...
							  <div class='card-body'>
							    ...
							    <a href='addtocart.php?matruyen=".$row['matruyen']."&tinhtrang=new' class='btn btn-success'>Chọn mua</a>
							  </div>
							</div>
							</div>
							";
